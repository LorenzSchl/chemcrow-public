...
class SafetySummary(BaseTool):
    ...
    description: str = Field(default="Input CAS number, returns a summary of safety information. The summary includes Operator safety, GHS information, Environmental risks, and Societal impact.")
    llm: Optional[BaseLLM] = Field(default=None)
    llm_chain: Optional[LLMChain] = Field(default=None)
    pubchem_data: Dict = Field(default_factory=dict)
    mol_safety: Optional[MoleculeSafety] = Field(default=None)
